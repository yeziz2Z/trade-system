...
public class TradeUser implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", userRefTime=").append(userRefTime);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            ...
            && (this.getUserRefTime() == null ? other.getUserRefTime() == null : this.getUserRefTime().equals(other.getUserRefTime()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUserRefTime() == null) ? 0 : getUserRefTime().hashCode());
